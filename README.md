...
<h6> It is always helpful to read official document and learn from it the other advanced keyword <a href="https://docs.gitlab.com/ee/ci/yaml/>   .gitlab-ci.yml keyword reference   </a> </h6>
